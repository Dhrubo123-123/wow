...
Phase 0-16 complete (foundation, mobile shell, Supabase auth/schema/RLS,
...
tree). The full core loop (goal → AI quest → evidence → AI evaluation →
XP → level up → skill unlock → next quest) works end-to-end against the
live Groq API and Supabase project. See
