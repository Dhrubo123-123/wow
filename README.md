...
Phase 0-19 complete (foundation, mobile shell, Supabase auth/schema/RLS,
...
tree, achievements, AI mentor, PWA). The full core loop (goal → AI
quest → evidence → AI evaluation → XP → level up → skill unlock →
